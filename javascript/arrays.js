//create an array
var colorList = ["Red", "Black", "White", "Green", "Yellow", "Blue", "Purple", "Orange", "Pink"];
...
function buildThumbnails()
{
  ...
  //third part: incrementor - adds one to the counter AFTER the code is executedin the brackets
